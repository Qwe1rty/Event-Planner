...
public final class Loader {
    ...
    private static final FileNameExtensionFilter FILE_FILTER =
            new FileNameExtensionFilter("*.event Files", FILE_EXTENSION);
     ...
     *
     * @return true if the load was successful.  Otherwise, false will be returned indicating corrupt file
     * @throws FileNotFoundException
     * @author Caleb Choi, Connor Murphy
     */
