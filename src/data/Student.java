...
public class Student {
	 ...
	 */
	public static void addStudent(Student student) {STUDENT_LIST.append(student);}
	
	/**
	 * Removes a student from the global student list, given an exemplar student
	 * @param student Student to be removed
	 */
	public static void removeStudent(Student student) {STUDENT_LIST.remove(student);}
	...
	public static void sort(Parameter param, boolean ascending) {
		...
		for (int gap = length / 2; gap > 0; gap /= 2) {
			for (int wall = gap; wall < length; wall++) {
				...
				} catch (Exception e) {System.out.println("nope");} // Should never be needed
			}
		}
	}
