...
public class SettingsPanel extends JPanel {
    ...
    public SettingsPanel() {
        ...
        MouseListener tableMouseListener = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                selectedRow = foodOptions.rowAtPoint(e.getPoint());//get mouse-selected row
                selectedCol = foodOptions.columnAtPoint(e.getPoint());//get mouse-selected col
                System.out.println(selectedRow + " " + selectedCol);
            }
        };

        foodOptions = new JTable(options, columnNames);
       // foodOptions.getModel().addTableModelListener(new TableListener());
    ...
    {
        /**
         * Removes the valid selected row from the table and from the global food list when this button is clicked
         * @param e the event
         */
        public void actionPerformed(ActionEvent e)
        {
