...
public class SettingsPanel extends JPanel {
    ...
    class SaveButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            Loader.saveAsFile();
            //Give a notification that the file was saved
            JOptionPane.showMessageDialog(EventPlanner.FRAME, "Event Saved", "Saved", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    class LoadButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            //Give a notification that the file was saved if sucessfull
            if(success) {
                JOptionPane.showMessageDialog(EventPlanner.FRAME, "File Loaded", "Loaded", JOptionPane.INFORMATION_MESSAGE);
            }
            else
            {
                JOptionPane.showMessageDialog(EventPlanner.FRAME, "File Corrupted", "Corrupted File", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
}